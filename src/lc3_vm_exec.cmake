...
macro(vm_exec_jsr instruction)
	# read flag, 1 means JSR 0 means JSRR
	lc3_bits(${instruction} 11 1 is_jsr)
...
macro(vm_exec_trap instruction)
	...
	elseif(trap_vector EQUAL 0x31)
		...
		lc3_hex(${trap_vector} trap_hex)
		lc3_hex(${PC} pc_hex)
		message(WARNING "Unknown TRAP vector ${trap_hex} at PC ${pc_hex}")
	endif()
endmacro()
